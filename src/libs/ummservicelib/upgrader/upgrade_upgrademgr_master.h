#ifndef UMM_SERVICE_UPGRADER_UPGRADE_UPGRADEMGR_MASTER_H
#define UMM_SERVICE_UPGRADER_UPGRADE_UPGRADEMGR_MASTER_H
...
#endif // UMM_SERVICE_UPGRADER_UPGRADE_UPGRADEMGR_MASTER_H
