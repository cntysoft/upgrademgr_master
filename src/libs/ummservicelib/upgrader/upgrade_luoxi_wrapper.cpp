...
void upgrade_luoxi_handler(const ServiceInvokeResponse &response, void* args)
{
   //需要判断对错
   UpgradeLuoXiWrapper *self = static_cast<UpgradeLuoXiWrapper*>(args);
...
UpgradeLuoXiWrapper::UpgradeLuoXiWrapper(sn::corelib::network::ServiceProvider &provider)
...
ServiceInvokeResponse UpgradeLuoXiWrapper::upgrade(const ServiceInvokeRequest& request)
{
   ...
   QString slaveServerAddress = args.value("targetServerAddress").toString();
   ...
   connect(invoker.data(), &ServiceInvoker::connectedToServerSignal, this, &UpgradeLuoXiWrapper::connectToServerHandler);
   connect(invoker.data(), &ServiceInvoker::connectErrorSignal, this, &UpgradeLuoXiWrapper::connectToServerErrorHandler);
...
void UpgradeLuoXiWrapper::connectToServerHandler()
{
...
void UpgradeLuoXiWrapper::connectToServerErrorHandler()
{
