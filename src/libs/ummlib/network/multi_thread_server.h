#ifndef UMM_LIB_NETWORK_MULTI_THREAD_SERVER_H
#define UMM_LIB_NETWORK_MULTI_THREAD_SERVER_H
...
class UMM_LIB_EXPORT MultiThreadServer : public AbstractMultiThreadServer
{
public:
...
UMM_LIB_EXPORT MultiThreadServer*& get_global_server();
UMM_LIB_EXPORT void set_global_server(MultiThreadServer* server);

}//network
}//ummlib

#endif // UMM_LIB_NETWORK_MULTI_THREAD_SERVER_H
